...
account_sid = 'ACf552fe19f1badb0c7931b2b53064316f'
auth_token = '58a57d7808800bc3b70195876f8cf956'
        ...
        while True:
            ...
            for (x, y, w, h) in faces:
                ...
                if drowsiness_status1 == 2 or drowsiness_status2 == 2:
                    drowsiness_count += 1
                    cv2.putText(frame, "Eyes Closed, Frame count: " + str(drowsiness_count), (10, 30), cv2.FONT_HERSHEY_COMPLEX, 1, (0, 0, 255), 1)

                    # If eyes are closed for 2 consecutive frames, start the alarm
                    if drowsiness_count >= 1 and not drowsiness_alarm_on:
